...
| 2 | `agent-handoff-02-handoff-skill` | 引き継ぎスキル `skills/umbrella-handoff/` の新設 | ✅ PR #73 マージ済 |
| 3 | `agent-handoff-03-trigger-distribution` | 発動条件を Claude Code / Codex / OpenCode の3エージェントへ配布 | ✅ PR #76 マージ済 |
